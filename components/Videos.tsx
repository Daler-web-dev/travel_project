   ...
   return (
      <div className="bg-white">
         ...
         <div className="grid grid-cols-4 max-2xl:grid-cols-3 max-lg:grid-cols-2 max-sm:grid-cols-1 gap-10 max-md:gap-5 px-20 max-lg:px-5">
            <div className="w-full h-full relative z-10 py-10 flex justify-center bg-gray-700 overfl">
               <div className="w-full h-full absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[100%]">
                  <video autoPlay={true} src="/images/video.mp4"></video>
               </div>
               <div className="w-64">
